...
namespace ContextMenuRector.Methods
{
    static class AppConfig
    {
        ...
        public const string GithubHome = "https://github.com/guanglinn/ContextMenuRector";
        public const string GithubLatest = "https://github.com/guanglinn/ContextMenuRector/releases/latest";
        public const string GithubLatestApi = "https://api.github.com/repos/guanglinn/ContextMenuRector/releases/latest";
        public const string GithubLangsApi = "https://api.github.com/repos/guanglinn/ContextMenuRector/contents/languages";
        public const string GithubLangsRawDir = "https://raw.githubusercontent.com/guanglinn/ContextMenuRector/master/languages";
        public const string GithubShellNewApi = "https://api.github.com/repos/guanglinn/ContextMenuRector/contents/ContextMenuManager/Properties/Resources/ShellNew";
        public const string GithubShellNewRawDir = "https://raw.githubusercontent.com/guanglinn/ContextMenuRector/master/ContextMenuManager/Properties/Resources/ShellNew";
        public const string GithubTexts = "https://raw.githubusercontent.com/guanglinn/ContextMenuRector/master/ContextMenuManager/Properties/Resources/Texts";
        public const string GithubDonateRaw = "https://raw.githubusercontent.com/guanglinn/ContextMenuRector/master/Donate.md";
        public const string GithubDonate = "https://github.com/guanglinn/ContextMenuRector/blob/master/Donate.md";

        public const string GiteeReleases = "https://gitee.com/guanglinn/ContextMenuRector/releases";
        public const string GiteeLatestApi = "https://gitee.com/api/v5/repos/guanglinn/ContextMenuRector/releases/latest";
        public const string GiteeLangsApi = "https://gitee.com/api/v5/repos/guanglinn/ContextMenuRector/contents/languages";
        public const string GiteeLangsRawDir = "https://gitee.com/guanglinn/ContextMenuRector/raw/master/languages";
        public const string GiteeShellNewApi = "https://gitee.com/api/v5/repos/guanglinn/ContextMenuRector/contents/ContextMenuManager/Properties/Resources/ShellNew";
        public const string GiteeShellNewRawDir = "https://gitee.com/guanglinn/ContextMenuRector/raw/master/ContextMenuManager/Properties/Resources/ShellNew";
        public const string GiteeTexts = "https://gitee.com/guanglinn/ContextMenuRector/raw/master/ContextMenuManager/Properties/Resources/Texts";
        public const string GiteeDonateRaw = "https://gitee.com/guanglinn/ContextMenuRector/raw/master/Donate.md";
        public const string GiteeDonate = "https://gitee.com/guanglinn/ContextMenuRector/blob/master/Donate.md";

        public static readonly string AppDataDir = Environment.ExpandEnvironmentVariables(@"%AppData%\" + Application.ProductName);
        ...
        public const string EN_US_INI = "en-US.ini";
