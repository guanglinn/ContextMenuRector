    ...
    static class AppString
    {
        ...
        public static void LoadStrings()
        {
            foreach (Type type in typeof(AppString).GetNestedTypes())
            {
                ...
                {
                    property.SetValue(type, GetValue(type.Name, property.Name), null);
                    // Trace.WriteLine($"[{type.Name}] {property.Name} = {property.GetValue(type, null)}");
                }
            }
        }
        ...
        public static class SideBar
        {
            ...
            public static string Contributors { get; set; }
        ...
        public static class Dialog
        {
            ...
            public static string Fork { get; set; }
        ...
        public static class Message
        {
            ...
            public static string RegEditUnavailable { get; set; }
            public static string RegEditNoWindow { get; set; }
            public static string RegEditExportFailed { get; set; }
        }
